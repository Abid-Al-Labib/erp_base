...
const ProfilePage = () => {
    ...
    const handleSettingsChange = async () => {
        toast.success("Change app setting done in FE")
    }
                                ...
                                <div>
                                    <div className="space-y-4">
                                        <div className="flex flex-row items-center justify-between rounded-lg border p-4">
                                            ...
                                            <div>
                                                <Switch checked={enableAddPart} onCheckedChange={setEnableAddPart} />
                                            </div>
                                        </div>
                                        <div className="flex flex-row items-center justify-between rounded-lg border p-4">
                                            <div className="space-y-0.5">
                                            ...
                                            <div>
                                                <Switch checked={enableResetPassword} onCheckedChange={setEnableResetPassword} aria-readonly />
                                            </div>
                                        </div>
                                    </div>
                                </div>
